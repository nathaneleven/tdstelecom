...
const  Footer = () => {
    return (
    <>
        <Box border="1" fontWeight="700" bgColor="#555555" color="#fff" align="center">
            <Flex p={{base:"8", xl:"50px 0"}} maxW="1272px" align="center" direction={{base: "column", md: "row"}} >
                ...
                <Flex align="center">
                    ...
                    <Button colorScheme="black" bgColor="#0C8FD0" size="lg" variant="solid" borderRadius="md">Sign Up</Button>
                </Flex>
            </Flex>
            ...
            <Box p="3" bgColor="#555555" color="white" align="center"  >
